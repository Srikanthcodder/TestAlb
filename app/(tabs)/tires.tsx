  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        {/* All Brands Tires Button */}
        <TouchableOpacity style={styles.allBrandsButton}>
          <TireIcon size={60} color="#E41E26" />
          <Text style={styles.allBrandsText}>ALL BRANDS TIRES</Text>
        </TouchableOpacity>

        {/* Branded Tires Section */}
        <View style={styles.brandsSection}>
          ...
          >
            ...
            <View style={styles.brandsGrid}>
              <BrandCard brandName="Brand 5" />
              <BrandCard brandName="Brand 6" />
            </View>
            <View style={styles.brandsGrid}>
              <BrandCard brandName="Brand 7" />
              <BrandCard brandName="Brand 8" />
            </View>
          </ScrollView>
        </View>
      </ScrollView>
