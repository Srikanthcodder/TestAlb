  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        {/* All Brands Batteries Button */}
        <TouchableOpacity 
          style={styles.allBrandsButton}
          onPress={() => toggleBrandSelection('All Brands')}
        >
          <BatteryIcon size={60} color="#E41E26" />
          <Text style={styles.allBrandsText}>ALL BRANDS BATTERIES</Text>
        </TouchableOpacity>

        {/* Branded Batteries Section */}
