  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        {/* All Brands Accessories Button */}
        <TouchableOpacity style={styles.allBrandsButton}>
          <AccessoriesIcon size={60} color="#E41E26" />
          <Text style={styles.allBrandsText}>ALL BRANDS ACCESSORIES</Text>
        </TouchableOpacity>

        {/* Branded Accessories Section */}
